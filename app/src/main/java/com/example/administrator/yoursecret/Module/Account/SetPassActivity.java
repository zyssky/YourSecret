...
public class SetPassActivity extends Activity  implements View.OnClickListener,SetPassObserver{
    ...
    public static SetPassActivity Instance;
    ...
    private void initView() {
        ...
        navigationView.setClickCallback(new NavigationView.ClickCallback() {
            ...
            public void onRightClick() {
                ...
                {
                    Toast.makeText(SetPassActivity.this,"旧密码不能为空",Toast.LENGTH_SHORT).show();
                }
                else if( new_password.length()==0)
                {
                    Toast.makeText(SetPassActivity.this,"新密码不能为空",Toast.LENGTH_SHORT).show();
                     ...
                     SetPassDataManager.getInstance().modifypas(old_password,new_password);
        ...
        set_old_password.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!s.toString().matches("[A-Za-z0-9]+")) {
                    ...
                    Toast.makeText(SetPassActivity.this, R.string.please_input_limit_pwd, Toast.LENGTH_SHORT).show();
